...
<section id="intro" class="section-intro">
    <div class="overlay">
        <div class="container">
            <div class="main-text">
                <h1 class="intro-title">Welcome To <span style="color:blue">Service</span> <span
                            style="color:red">Hunt</span></h1>
                <p class="sub-title" style="font-size: 25px">Search, Sell and Rate Services Online</p>
